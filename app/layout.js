...
export default function RootLayout({ children }) { return <html lang="en"><body>{children}<JsonLd data={{ "@context": "https://schema.org", "@type": "WebSite", "@id": `${siteUrl}/#website`, name: "Truong Phan", url: siteUrl }} /><GoogleAnalytics gaId="G-SKQB1ZFXMY" /></body></html>; }
