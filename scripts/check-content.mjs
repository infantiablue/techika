...
assert.equal(posts.length, 13, "all thirteen Markdown posts must be present");
...
for (const asset of ["assets/img/header.jpg", "favicon.ico", "favicon.png", "llms.txt", "media/basic-arithmetic-algorithm/cover.png", "media/vhnews-tutorials/banner.jpg", "media/vhnews-tutorials-p2/darkmode.png", "media/simple-notes-javascript/js-object-cheatsheet.jpg"]) {
